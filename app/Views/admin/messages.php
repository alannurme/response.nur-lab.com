                    ...
                    <tr style="<?= $msg['status'] === 'unread' ? 'background: rgba(0, 107, 67, 0.02); font-weight: 600;' : '' ?>">
                        ...
                        <td style="text-align: center;">
                            <div class="action-buttons" style="justify-content: center; gap: 8px;">
                                <a href="mailto:<?= htmlspecialchars($msg['email']) ?>?subject=Re: <?= urlencode($msg['subject']) ?>" class="action-btn" title="Reply via Email" style="background: rgba(37, 99, 235, 0.1); color: #2563eb;">
