...
<div class="admin-header">
        <div>
            <h1 style="font-size: 1.8rem; font-weight: 800; color: var(--text-main); margin-bottom: 0.25rem;">
                <i class="fas fa-plus-circle" style="color: var(--primary); margin-right: 10px;"></i> Add New Module (নতুন মডিউল)
            </h1>
            <p style="color: var(--text-muted); font-size: 0.95rem;">Create a new topic module for the frontend mega menu.</p>
        </div>
    ...
    <form action="<?= URLROOT ?>/admin/add_module" method="POST">
        <div class="form-grid" style="grid-template-columns: 2fr 1fr; gap: 2rem;">
            ...
            <div style="background: white; border-radius: 16px; padding: 25px; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0,0,0,0.03);">
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="title" required placeholder="যেমন: ঈমান ও আকীদা / প্রশ্ন ও উত্তর" style="width: 100%; padding: 12px 16px; border-radius: 10px; border: 1.5px solid #cbd5e1; font-size: 1rem; outline: none; transition: 0.2s;" onfocus="this.style.borderColor='var(--primary)';" onblur="this.style.borderColor='#cbd5e1';">
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="url" value="#" placeholder="যেমন: /category/aqeedah অথবা https://..." style="width: 100%; padding: 12px 16px; border-radius: 10px; border: 1.5px solid #cbd5e1; font-size: 1rem; outline: none; transition: 0.2s;" onfocus="this.style.borderColor='var(--primary)';" onblur="this.style.borderColor='#cbd5e1';">
                </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                <div style="background: white; border-radius: 16px; padding: 25px; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0,0,0,0.03);">
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <input type="text" name="icon" value="fas fa-cube" placeholder="fas fa-kaaba, fas fa-book..." style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1.5px solid #cbd5e1; font-size: 0.95rem;">
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <input type="number" name="order_index" value="0" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1.5px solid #cbd5e1; font-size: 0.95rem;">
                    </div>
                    ...
                    <button type="submit" style="width: 100%; background: var(--primary); color: white; border: none; padding: 14px; border-radius: 10px; font-weight: 700; font-size: 1rem; cursor: pointer; transition: 0.3s; box-shadow: 0 4px 15px rgba(37, 99, 235, 0.3);" onmouseover="this.style.background='var(--primary-dark)';" onmouseout="this.style.background='var(--primary)';">
                        <i class="fas fa-save" style="margin-right: 8px;"></i> Save Module
                    </button>
                </div>
            </div>
        </div>
