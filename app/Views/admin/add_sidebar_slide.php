    ...
    <form action="<?= URLROOT ?>/admin/add_sidebar_slide" method="POST">
        <div class="form-group mb-4">
            ...
            <div style="display: flex; gap: 15px; align-items: flex-start;">
                <img id="slide_preview" src="" style="width: 120px; height: 120px; aspect-ratio: 1/1; object-fit: cover; border-radius: 10px; display: none; border: 1px solid #ddd; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" loading="lazy" decoding="async">
                <div style="flex: 1;">
