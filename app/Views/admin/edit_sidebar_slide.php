...
<div class="admin-card" style="max-width: 800px; margin: 0 auto;">
    ...
    <form action="<?= URLROOT ?>/admin/edit_sidebar_slide/<?= $data['slide']['id'] ?>" method="POST">
        <div class="form-group mb-4">
            <label>Sidebar Image (1:1 Aspect Ratio Recommended - e.g. 600x600px)</label>
            <div style="display: flex; gap: 15px; align-items: flex-start;">
                <img id="slide_preview" src="<?=htmlspecialchars($data['slide']['image'])?>" loading="lazy" decoding="async" style="width: 120px; height: 120px; aspect-ratio: 1/1; object-fit: cover; border-radius: 10px; border: 1px solid #ddd; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                <div style="flex: 1;">
